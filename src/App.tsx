    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
      <div className="bg-white text-slate-900 rounded-xl max-w-4xl w-full flex flex-col my-8 shadow-2xl relative max-h-[90vh]">
        ...
        <div className="p-8 md:p-12 overflow-y-auto" id="printable-report">
          ...
          <h2 className="text-lg font-bold mb-4 uppercase text-slate-800 border-b pb-2">Stage-Wise Environmental Breakdown</h2>
          <table className="w-full text-left border-collapse text-sm">
            <thead>
              <tr className="bg-slate-100 text-slate-700">
                <th className="p-3 border-b-2 font-bold w-2/4">Supply Chain Stage</th>
                <th className="p-3 border-b-2 font-bold w-2/4 text-right">Metrics & Impact</th>
              </tr>
            </thead>
            <tbody>
              {stagesBreakdown.map((row, i) => (
                <tr key={i} className="border-b border-slate-200 hover:bg-slate-50">
                  <td className="p-3 font-semibold text-slate-800 border-r border-slate-200">{row.stage}</td>
